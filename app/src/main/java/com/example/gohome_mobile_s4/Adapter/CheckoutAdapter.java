...
public class CheckoutAdapter extends RecyclerView.Adapter <CheckoutAdapter.Viewholder> {
    ...
    public CheckoutAdapter(List<CheckoutModel> checkoutModelList){
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, int position) {
        int resource = checkoutModelList.get(position).getImageview();
        String jKamar = checkoutModelList.get(position).getTextview1();
        String harga = checkoutModelList.get(position).getTextview2();
        String status = checkoutModelList.get(position).getTextview3();
